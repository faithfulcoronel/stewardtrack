...
const STANDARD_ROLES = [
  {
    key: 'tenant_admin',
    label: 'Tenant Admin',
    description: 'Full administrative control over all tenant resources',
    defaultFor: ['view', 'manage', 'create', 'update', 'delete', 'export', 'approve'],
  },
  {
    key: 'senior_pastor',
    label: 'Senior Pastor',
    description: 'Primary spiritual leader with full operational access',
    defaultFor: ['view', 'manage', 'create', 'update', 'delete', 'export', 'approve'],
  },
  {
    key: 'associate_pastor',
    label: 'Associate Pastor',
    description: 'Pastoral staff with comprehensive ministry access',
    defaultFor: ['view', 'create', 'update', 'delete', 'export'],
  },
  {
    key: 'ministry_leader',
    label: 'Ministry Leader',
    description: 'Department or group leader with operational capabilities',
    defaultFor: ['view', 'create', 'update'],
  },
  {
    key: 'treasurer',
    label: 'Treasurer',
    description: 'Financial transaction creator (Maker role)',
    defaultFor: ['view', 'create', 'update', 'export'],
  },
  {
    key: 'auditor',
    label: 'Auditor',
    description: 'Financial approver and oversight (Checker role)',
    defaultFor: ['view', 'approve', 'export'],
  },
  {
    key: 'secretary',
    label: 'Secretary',
    description: 'Administrative support for records and communications',
    defaultFor: ['view', 'create', 'update', 'export'],
  },
  {
    key: 'deacon_elder',
    label: 'Deacon/Elder',
    description: 'Board oversight with budget approval authority',
    defaultFor: ['view', 'approve'],
  },
  {
    key: 'volunteer',
    label: 'Volunteer',
    description: 'Task-specific access for service activities',
    defaultFor: ['view'],
  },
  {
    key: 'member',
    label: 'Member',
    description: 'Self-service access for personal information',
    defaultFor: [],
  },
  {
    key: 'visitor',
    label: 'Visitor',
    description: 'Public information access only',
    defaultFor: [],
  },
];
