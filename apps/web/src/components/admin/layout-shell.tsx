    ...
    >
      ...
      >
        ...
        <div className="flex min-h-screen flex-col">
          <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 px-4 py-3 pt-[max(0.75rem,var(--safe-area-top))] backdrop-blur sm:px-6 sm:py-4">
