...
import type { IReligiousDenominationRepository } from '@/repositories/religiousDenomination.repository';
...
export class ReligiousDenominationService
  implements CrudService<ReligiousDenomination> {
  constructor(
    @inject(TYPES.IReligiousDenominationRepository)
    private repo: IReligiousDenominationRepository,
  ) {}
  ...
  async getActive(): Promise<ReligiousDenomination[]> {
