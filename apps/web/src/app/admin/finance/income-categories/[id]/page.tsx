/**
 * Income Category Profile Page
 *
 * View details of a specific income category.
 *
...
export const metadata: Metadata = {
  title: 'Income Category Details | StewardTrack',
};

export default async function IncomeCategoryProfilePage({ params, searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('income-categories/profile', {
