...
export const metadata: Metadata = {
  title: 'Income Categories | StewardTrack',
};

export default async function IncomeCategoriesListPage({ searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('income-categories', resolvedSearchParams ?? {});
