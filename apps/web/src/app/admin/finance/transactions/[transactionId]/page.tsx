...
export const metadata: Metadata = {
  title: 'Transaction Details | StewardTrack',
};

export default async function TransactionProfilePage({ params, searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('transactions/profile', {
