...
export const metadata: Metadata = {
  title: 'Funds | StewardTrack',
};

export default async function FundsListPage({ searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('funds/list', resolvedSearchParams ?? {});
