/**
 * Expense Category Profile Page
 *
 * View details of a specific expense category.
 *
...
export const metadata: Metadata = {
  title: 'Expense Category Details | StewardTrack',
};

export default async function ExpenseCategoryProfilePage({ params, searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('expense-categories/profile', {
