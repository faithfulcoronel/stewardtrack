...
export const metadata: Metadata = {
  title: 'Expense Categories | StewardTrack',
};

export default async function ExpenseCategoriesListPage({ searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('expense-categories', resolvedSearchParams ?? {});
