 ...
 *
 * Display detailed information about a specific recurring donation subscription.
 *
...
export const metadata: Metadata = {
  title: 'Recurring Donation Details | StewardTrack',
};

export default async function RecurringDonationProfilePage({ params, searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('donations/recurring/profile', {
