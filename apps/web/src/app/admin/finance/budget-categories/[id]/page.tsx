/**
 * Budget Category Profile Page
 *
 * View details of a specific budget category.
 *
...
export const metadata: Metadata = {
  title: 'Budget Category Details | StewardTrack',
};

export default async function BudgetCategoryProfilePage({ params, searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('budget-categories/profile', {
