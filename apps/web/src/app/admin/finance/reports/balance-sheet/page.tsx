 ...
 *
 * Display balance sheet showing assets, liabilities, and equity.
 *
...
export const metadata: Metadata = {
  title: 'Balance Sheet | StewardTrack',
};
...
export default async function BalanceSheetPage({ searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('reports/balance-sheet', resolvedSearchParams ?? {});
