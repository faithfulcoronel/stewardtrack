...
export const metadata: Metadata = {
  title: 'Manage Fiscal Year | StewardTrack',
};

export default async function FiscalYearManagePage({ searchParams }: PageProps) {
  ...
  const { content } = await renderFinancePage('fiscal-years/manage', resolvedSearchParams ?? {});
