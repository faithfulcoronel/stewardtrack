...
import { MetadataClientProvider, FormValuesProvider } from "@/lib/metadata/context";

import { getMembershipContext } from "@/app/admin/members/context";

export type PageSearchParams = Record<string, string | string[] | undefined>;

export async function renderSchedulerPage(route: string, searchParams: PageSearchParams) {
  ...
  return {
    content: React.createElement(
      ...
      // Wrap with FormValuesProvider to share form state between components
      React.createElement(FormValuesProvider, null, content),
    ),
  };
}
