...
const NAV_SECTIONS: AdminNavSection[] = [
  ...
  },
  {
    label: "Finance",
    items: [
      { title: "Dashboard", href: "/admin/finance", icon: "finances", isPro: true },
      { title: "Chart of Accounts", href: "/admin/finance/accounts", icon: "finances", isPro: true },
      { title: "Income Sources", href: "/admin/finance/sources", icon: "expenses", isPro: true },
      { title: "Transactions", href: "/admin/finance/transactions", icon: "expenses", isPro: true },
      { title: "Budgets", href: "/admin/finance/budgets", icon: "finances", isPro: true },
      { title: "Fiscal Years", href: "/admin/finance/fiscal-years", icon: "calendar", isPro: true },
      { title: "Funds", href: "/admin/finance/funds", icon: "finances", isPro: true },
      { title: "Income Categories", href: "/admin/finance/income-categories", icon: "expenses", isPro: true },
      { title: "Expense Categories", href: "/admin/finance/expense-categories", icon: "expenses", isPro: true },
      { title: "Budget Categories", href: "/admin/finance/budget-categories", icon: "finances", isPro: true },
      { title: "Opening Balances", href: "/admin/finance/opening-balances", icon: "finances", isPro: true },
      { title: "Reports", href: "/admin/finance/reports", icon: "reports", isPro: true },
    ],
  },
  {
