...
const NAV_SECTIONS: AdminNavSection[] = [
  ...
  },
  {
    label: "Planning",
    items: [
      { title: "Dashboard", href: "/admin/community/planning", icon: "dashboard", isPro: true },
      { title: "Calendar", href: "/admin/community/planning/calendar", icon: "calendar", isPro: true },
      { title: "Scheduler", href: "/admin/community/planning/scheduler", icon: "scheduler", isPro: true },
      { title: "Goals & Objectives", href: "/admin/community/planning/goals", icon: "goals", isPro: true },
      { title: "Notebooks", href: "/admin/community/planning/notebooks", icon: "notebooks", isPro: true },
    ],
  },
  {
    label: "Accounts",
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Treasury Overview", href: "/admin/finance", icon: "treasury", isPro: true },
      { title: "Financial Records", href: "/admin/finance/transactions", icon: "transactions", isPro: true },
      { title: "Online Donations", href: "/admin/finance/donations", icon: "giving", isPro: true },
      { title: "Ministry Budgets", href: "/admin/finance/budgets", icon: "ledger", isPro: true },
      { title: "Financial Reports", href: "/admin/finance/reports", icon: "financialReports", isPro: true },
    ],
    subGroups: [
      {
        ...
        items: [
          // Account Structure
          { title: "Chart of Accounts", href: "/admin/finance/accounts", icon: "chartOfAccounts", isPro: true },
          { title: "Treasury Accounts", href: "/admin/finance/sources", icon: "expenses", isPro: true },
          { title: "Ministry Funds", href: "/admin/finance/funds", icon: "funds", isPro: true },
          { title: "Fiscal Years", href: "/admin/finance/fiscal-years", icon: "calendar", isPro: true },
          // Categories
          { title: "Giving Categories", href: "/admin/finance/income-categories", icon: "income", isPro: true },
