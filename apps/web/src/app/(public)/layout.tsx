...
export default async function PublicLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {/* Header */}
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/95 pt-[var(--safe-area-top)] backdrop-blur supports-[backdrop-filter]:bg-background/80">
      ...
      {/* Footer */}
      <footer className="border-t border-border/60 bg-muted/30 pb-[var(--safe-area-bottom)]">
