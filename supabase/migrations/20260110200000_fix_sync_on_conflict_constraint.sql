-- ============================================================================
-- RPC Function: sync_tenant_subscription_features (v5 - Fix ON CONFLICT)
-- ============================================================================
-- Fixed ON CONFLICT clause to work with the unique index that includes
-- COALESCE expressions. Using simple ON CONFLICT DO NOTHING which handles
-- any unique violation, combined with WHERE NOT EXISTS for primary filtering.
-- ============================================================================
...
BEGIN
  ...
  -- Using ON CONFLICT DO NOTHING without column specification to handle
  -- the unique index with COALESCE expressions
...
DO $$
BEGIN
  RAISE NOTICE 'Fixed sync_tenant_subscription_features ON CONFLICT constraint issue';
END $$;
