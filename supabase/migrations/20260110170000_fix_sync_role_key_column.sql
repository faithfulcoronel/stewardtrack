...
-- ============================================================================
-- Fixes column reference: uses role_key instead of role_metadata_key
-- in permission_role_templates table.
-- ============================================================================
  ...
  LOOP
    ...
    LOOP
      ...
      IF NOT EXISTS (
        ...
        -- Note: column is role_key, not role_metadata_key
        FOR v_template IN
          SELECT prt.role_key
...
DO $$
BEGIN
  RAISE NOTICE 'Fixed sync_tenant_subscription_features RPC function - corrected role_key column reference';
END $$;
