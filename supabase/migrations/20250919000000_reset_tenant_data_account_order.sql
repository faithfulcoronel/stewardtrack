-- Update reset_tenant_data to delete accounts before members
...
BEGIN
  ...
  -- Reset status of headers to avoid posted transaction restrictions
  ...
  -- Accounts reference members so remove them before deleting members
