-- Filter deleted financial transaction headers and transactions in source_recent_transactions_view
...
-- Recreate materialized view with deleted header and transaction filters
