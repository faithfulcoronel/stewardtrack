...
-- Create improved function to handle user creation with email check
...
COMMENT ON FUNCTION handle_user_creation IS
  'Creates a new user with proper role assignments, tenant association, and member profile. Includes email duplication check.';