/*
  # Add Multi-Tenant Support Functions

  1. New Functions
    - `get_current_tenant()` - Gets the current user's tenant
    - `create_tenant_invitation()` - Creates a new invitation
    - `accept_tenant_invitation()` - Accepts an invitation
