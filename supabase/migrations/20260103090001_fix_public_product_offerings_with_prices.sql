-- =============================================================================
-- Migration: Fix get_public_product_offerings RPC to use product_offering_prices
-- =============================================================================
-- The base_price and currency columns were removed from product_offerings table.
-- This migration updates the RPC function to get prices from product_offering_prices table.
--
-- Changes:
-- - Replaces base_price and currency with prices JSONB array
-- - Keeps the 4-parameter signature (no target_currency parameter)
-- =============================================================================
...
-- Create updated function that uses product_offering_prices table
...
COMMENT ON FUNCTION public.get_public_product_offerings(boolean, boolean, text, uuid)
  IS 'Returns active product offerings with prices from product_offering_prices table for multi-currency support.';
