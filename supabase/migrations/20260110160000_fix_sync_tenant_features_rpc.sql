-- ============================================================================
-- Fix: sync_tenant_subscription_features RPC function
-- ============================================================================
-- Removes invalid reference to fp.deleted_at column which does not exist
-- in the feature_permissions table.
-- ============================================================================
...
BEGIN
  ...
  LOOP
    ...
    -- Note: feature_permissions table does NOT have deleted_at column
    FOR v_permission IN
      SELECT
        fp.permission_code,
        fp.display_name,
      ...
      IF NOT EXISTS (
        ...
        LOOP
          ...
          FOR v_role IN
            ...
            WHERE tenant_id = p_tenant_id
              AND metadata_key = v_template.role_key
...
DO $$
BEGIN
  RAISE NOTICE 'Fixed sync_tenant_subscription_features RPC function - removed invalid deleted_at reference';
END $$;
