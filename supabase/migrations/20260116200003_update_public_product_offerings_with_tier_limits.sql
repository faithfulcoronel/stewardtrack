-- =============================================================================
-- Migration: Update get_public_product_offerings RPC with tier limits
-- =============================================================================
-- Adds the new tier limit columns to the RPC function return type:
-- - max_members
-- - max_sms_per_month
...
-- Create updated function with tier limit columns
...
COMMENT ON FUNCTION public.get_public_product_offerings(boolean, boolean, text, uuid)
  IS 'Returns active product offerings with tier limits and prices for multi-currency support.';
