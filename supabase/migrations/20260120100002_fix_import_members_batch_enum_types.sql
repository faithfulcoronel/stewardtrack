-- =============================================================================
-- Migration: Fix import_members_batch RPC function enum types
-- =============================================================================
-- Description: Fix gender and marital_status casting to proper enum types
-- Date: 2026-01-20
-- Issue: The function was casting gender/marital_status to ::text but the
--        members table uses gender_type and marital_status_type enums
-- =============================================================================

BEGIN;

-- =============================================================================
-- RPC Function: import_members_batch (fixed enum types)
-- =============================================================================
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      v_gender := LOWER(TRIM(v_member->>'gender'));
      IF v_gender NOT IN ('male', 'female', 'other') THEN
        v_gender := NULL;
      END IF;

      -- Normalize marital status value
      v_marital_status := LOWER(TRIM(v_member->>'marital_status'));
      IF v_marital_status NOT IN ('single', 'married', 'widowed', 'divorced', 'engaged') THEN
...
DO $$
BEGIN
  RAISE NOTICE 'Fixed import_members_batch RPC function - fixed enum type casting for gender and marital_status';
END $$;
