-- =====================================================================================
-- MIGRATION: Fix tenant_feature_grants Column Usage in assign_license_to_tenant
-- =====================================================================================
-- This migration fixes the assign_license_to_tenant function to use the correct
-- columns that actually exist in the tenant_feature_grants table.
-- The table has: grant_source, created_by, created_at (not granted_at)
-- =====================================================================================
...
BEGIN
  ...
  IF v_previous_offering_id IS NOT NULL THEN
    ...
    LOOP
      ...
      WHERE tenant_feature_grants.tenant_id = p_tenant_id
        AND tenant_feature_grants.feature_id = v_old_feature_id
        AND tenant_feature_grants.grant_source = 'direct';
