...
BEGIN
  ...
  (new_tenant_id, 'Lot Fund', 'restricted', 'Land purchase for future buildings or expansion'),
  (new_tenant_id, 'Missions Fund', 'restricted', 'Local & foreign missionary support'),
  (new_tenant_id, 'Youth Ministry Fund', 'restricted', 'Camps, fellowships, materials for youth'),
  (new_tenant_id, 'Children''s / DVBS Fund', 'restricted', 'Sunday School, Vacation Bible School'),
  (new_tenant_id, 'Love Gift / Benevolence Fund', 'restricted', 'Assisting members in financial crisis'),
  (new_tenant_id, 'Pastor''s Care Fund', 'restricted', 'For pastor''s family, medical needs, etc.'),
  (new_tenant_id, 'Scholarship Fund', 'restricted', 'For sponsoring Bible school or academic students'),
  (new_tenant_id, 'Church Planting Fund', 'restricted', 'Support for new churches, missions, outreaches'),
  (new_tenant_id, 'Music / Worship Fund', 'restricted', 'Equipment, uniforms, musical training'),
  (new_tenant_id, 'Transportation Fund', 'restricted', 'For church vehicles or travel needs'),
  (new_tenant_id, 'Media & Livestream Fund', 'restricted', 'Equipment for digital outreach and livestream'),
  (new_tenant_id, 'Anniversary / Events Fund', 'restricted', 'For special events, anniversaries, joint fellowships'),
  (new_tenant_id, 'Endowment Fund', 'restricted', 'Long-term investment with restricted use')
