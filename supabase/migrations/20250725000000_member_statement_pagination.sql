-- Add pagination support to get_member_statement
...
END;
$$;
GRANT EXECUTE ON FUNCTION get_member_statement(date, date, integer, integer) TO authenticated;
COMMENT ON FUNCTION get_member_statement(date, date, integer, integer) IS
  'Detailed giving transactions for active or donor members within a date range with optional pagination.';
