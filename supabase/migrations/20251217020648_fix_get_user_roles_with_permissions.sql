-- =====================================================================================
-- MIGRATION: Fix get_user_roles_with_permissions Function
-- =====================================================================================
-- Recreates get_user_roles_with_permissions function after role_menu_items table was dropped
-- This function is used throughout the app to get user roles and permissions
-- =====================================================================================

BEGIN;

-- Drop and recreate the function without any references to role_menu_items
