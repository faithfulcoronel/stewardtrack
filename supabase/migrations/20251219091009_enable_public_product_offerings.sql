-- =============================================================================
-- Migration: Enable Public Access to Active Product Offerings (Read-Only)
-- -----------------------------------------------------------------------------
-- Creates a security-definer function that returns sanitized product offering
-- data for unauthenticated experiences (e.g., public signup flow) without
-- relaxing table-level RLS policies.
-- =============================================================================
...
REVOKE ALL ON FUNCTION public.get_public_product_offerings(boolean, boolean, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_public_product_offerings(boolean, boolean, text) TO anon, authenticated;

COMMENT ON FUNCTION public.get_public_product_offerings(boolean, boolean, text)
