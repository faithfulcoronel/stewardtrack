    ...
    return (
      <div className="space-y-4">
        <div className="space-y-2">
          <h1 className="text-3xl font-semibold">Bento grids</h1>
          <p className="text-sm text-muted-foreground">
            No bento grid blueprints were discovered under the ui-blocks module. Add XML definitions and recompile metadata to see them here.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-10">
      <div className="space-y-2">
        <h1 className="text-3xl font-semibold">Bento grids</h1>
        <p className="text-sm text-muted-foreground">
          Explore composable bento blueprints defined entirely in XML. Click a card to open the rendered experience in a new tab.
        </p>
      </div>
