...
**Last Updated:** Feature codes aligned with codebase (dotted notation)
...
| Licensable Features | 23 |
| Proposed Permissions | 75+ |
...
| **Professional** | All Core + Premium | `finance.management`, `finance.budgets`, `integrations.sms`, `integrations.email_advanced`, `rbac.management`, `members.bulk` |
...
*Document generated by Claude Code audit - January 2026 (v1.2)*
