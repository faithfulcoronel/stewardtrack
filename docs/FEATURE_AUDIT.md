...
**Last Updated:** Added members.self-service feature for member profile self-view and self-edit
...
| Protected Pages | 4 |
| API Routes | 140 |
| Metadata Blueprints | 134 |
| Licensable Features | 27 |
| Proposed Permissions | 93+ |
...
**Display Name:** Member Self-Service Portal
**Category:** Core
**Description:** Allows members to view and update their own profile information
**Tier:** Essential (Core) - Available to ALL tiers

| Permission Code | Display Name | Description | Required |
|-----------------|--------------|-------------|----------|
| `members:view_self` | View Own Profile | Member can view their own profile | Yes |
| `members:edit_self` | Edit Own Profile | Member can edit limited fields on their profile | Yes |

**Pages:**
- `/portal/profile` - Member self-view profile

**API Endpoints:**
- `GET /api/portal/profile` - Get own profile
- `PATCH /api/portal/profile` - Update own profile (limited fields)

**Features:**
- Mobile-first card-based profile layout
- Role-aware field visibility (members see limited fields)
- Self-edit for contact, emergency, and ministry interests
- Read-only view of family, serving, and groups
...
|------|---------------------------|---------------------------|
| **Essential** | `members.core`, `members.self-service`, `households.core`, `groups.core`, `events.core`, `goals.core`, `finance.core`, `notifications.core`, `integrations.email`, `rbac.core`, `settings.core`, `dashboard.core`, `reports.core` | — |
...
| `members.self-service` | `members:view_self`, `members:edit_self` |
...
|--------------|-----------|---------|--------------|------------|
| **Members** | View, Create, Edit, Self-Service | + Invitations, Export | + Bulk Operations | Unlimited |
...
*Document generated by Claude Code audit - January 2026 (v1.6)*
